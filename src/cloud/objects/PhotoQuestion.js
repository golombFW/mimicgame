    ...
    if (photoQuestion.dirty("reportStatus") && isReportInspected) {
        ...
        reportQuery.find().then(function (reports) {
            ...
            _.each(reports, function (report) {
                promise = promise.then(function () {
                    ...
                    if (reportStatus === model.reportStatus.VALID) {
                        ...
                        playerScorePromise = playerScore.save();
                    } else {
            ...
            if (reportStatus === model.reportStatus.VALID) {
                ...
                gameScoreQuery.first().then(function (authorScore) {
                    authorScore.increment("score", (-1) * VALID_REPORT_BONUS);
                    return authorScore.save();
                }).then(function () {
